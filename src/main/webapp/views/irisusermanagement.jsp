...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/iris/resources/vendors/css/vendors.min.css">
    <link rel="stylesheet" type="text/css" href="/iris/resourcess/vendors/css/forms/select/select2.min.css">
...
<div class="col-12 p-2" id="bigDiv">
   ...
   <footer class="footer footer-static footer-light">
    ...
    <!-- BEGIN: Page Vendor JS-->
    <script src="/iris/resources/js/ui/jquery.sticky.js"></script>
