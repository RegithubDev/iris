...
<body style="padding-right: 11px; overflow: hidden;">
	<div id="root" aria-hidden="true">
		<div class="App_App__1WLdD">
		<jsp:include page="../views/layout/sideMenu.jsp"></jsp:include> 
			<div>
				...
				<div class=""
					...
					<div class=""
						...
						<div
							style="box-shadow: rgb(241, 25, 70) 0px 0px 10px, rgb(241, 25, 70) 0px 0px 10px; width: 5%; opacity: 1; position: absolute; height: 100%; transform: rotate(3deg) translate(0px, -4px); left: -5.5%;"></div>
					</div>
				</div>
				<div class="Container_PageHolder__0xvW1">
					<div class="main_container__nbQAZ">
						<div class="main_subContainer__W-R19">
							<div class="main_items__nW8jK">
								<div class="main_leftArea__OF2wx">
									<div class="profile_container__lomjR">
										<h1>Profile Pic</h1>
										<span class="profile_profileimg__kevMK"><img
											src="/static/media/avatar.a6143582309785dca610.png"
											alt="profileImage"></span>
										<p class="profile_heading__lujaQ">Upload Your Image here</p>
										<div class="profile_outerFiles__2s2jY">
											<div class="profile_files__xB6xL" role="button" tabindex="0">
												<svg
													class="MuiSvgIcon-root MuiSvgIcon-fontSizeMedium css-vubbuv"
													focusable="false" aria-hidden="true" viewBox="0 0 24 24"
													data-testid="FileUploadIcon">
													<path d="M9 16h6v-6h4l-7-7-7 7h4zm-4 2h14v2H5z"></path></svg>
												<p>Choose file</p>
											</div>
									...
									<div>
										<form>
											<div class="PersonalDetails_container__qhRU9">
												<h1>Personal Details</h1>
												<div class="PersonalDetails_formFiled__Mff1n">
													<div class="PersonalDetails_firstFormfield__Rgmay">
														<div class="PersonalDetails_innerFormFiled__ugo3Z">
															<div class="InputHook_InputBox__o9y+P">
																<label>First Name</label>
																<div class="InputHook_InputHolder__CWrwS">
																	<input placeholder="First Name" type="text"
																		name="firstName" autocomplete="new-password"
																		value="Admin">
																</div>
																<span class="InputHook_Error__HilTf"></span>
															</div>
															<div class="InputHook_InputBox__o9y+P">
														...
														<div class="InputHook_InputBox__o9y+P">
															...
															<div class="InputHook_InputHolder__CWrwS">
																<input placeholder="Email Address" type="text"
																	disabled="" name="emailId" autocomplete="new-password"
														...
														<div class="InputHook_InputBox__o9y+P">
															...
															<div class="InputHook_InputHolder__CWrwS">
																<input placeholder="Mobile Number" type="text"
																	name="phoneNumber" autocomplete="new-password"
																	value="8979806956">
															</div>
															<span class="InputHook_Error__HilTf"></span>
														</div>
													</div>
													<div class="PersonalDetails_passwordField__U5tjS">
														<p>Update Password</p>
													</div>
												</div>
											</div>
											<div class="PersonalDetails_btn__4hxlA">
												<button class="PersonalDetails_btnOne__2B58v" type="button">Cancel</button>
												<button type="submit" class="PersonalDetails_btnTwo__Wz90C">Update</button>
											</div>
										</form>
									</div>
								</div>
