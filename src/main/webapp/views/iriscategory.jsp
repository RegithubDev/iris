                     ...
                     <form id="jquery-val-form" method="post" novalidate="novalidate">
                      <div class="mb-1">
			            ...
			            <div class="mb-1">
			              ...
			              <input type="text" class="form-control" id="category_code" name="category_code" placeholder="SBU NAME">
			            </div>
			             <div class="mb-1">
			              <label class="form-label" for="category_name">Category Name</label>
			              <input type="text" class="form-control" id="category_name" name="category_name" placeholder="SBU NAME">
			            </div>
			                <div class="mb-1">
