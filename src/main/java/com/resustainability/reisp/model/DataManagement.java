...
public DataManagement(String mergedValue) {
...
public String toString() {
	return "DataManagement [id=" + id + ", total_materials=" + total_materials + ", total_recylable=" + total_recylable
			+ ", total_bags=" + total_bags + ", status=" + status + ", total_glass=" + total_glass
			+ ", total_cardboard=" + total_cardboard + ", site_name=" + site_name + ", quality_measure_materials="
			+ quality_measure_materials + ", quality_measure_recylable=" + quality_measure_recylable
			+ ", quality_measure_plastics=" + quality_measure_plastics + ", quality_measure_bags="
			+ quality_measure_bags + ", quality_measure_glass=" + quality_measure_glass + ", quality_measure_cardboard="
			+ quality_measure_cardboard + ", site=" + site + ", comments=" + comments + ", date=" + date
			+ ", created_by=" + created_by + ", modified_date=" + modified_date + ", created_date=" + created_date
			+ ", modified_by=" + modified_by + ", total_waste=" + total_waste + ", total_incieration="
			+ total_incieration + ", total_autoclave=" + total_autoclave + ", quantity_measure_waste="
			+ quantity_measure_waste + ", quantity_measure_incieration=" + quantity_measure_incieration
			+ ", quantity_measure_rdf_outflow=" + quantity_measure_rdf_outflow + ", quantity_measure_compost_outflow="
			+ quantity_measure_compost_outflow + ", quantity_measure_recyclables_outflow="
			+ quantity_measure_recyclables_outflow + ", quantity_measure_inerts_outflow="
			+ quantity_measure_inerts_outflow + ", quantity_measure_autoclave=" + quantity_measure_autoclave
			+ ", sbu_code=" + sbu_code + ", quantity=" + quantity + ", quantity_measure=" + quantity_measure + ", role="
			+ role + ", department_code=" + department_code + ", department_name=" + department_name + ", rdf=" + rdf
			+ ", compost=" + compost + ", recyclables=" + recyclables + ", inserts=" + inserts + ", vendor_name_rdf="
			+ vendor_name_rdf + ", vendor_name_compost=" + vendor_name_compost + ", vendor_name_recyclables="
			+ vendor_name_recyclables + ", vendor_name_inserts=" + vendor_name_inserts + ", vendor_name_rdf_outflow="
			+ vendor_name_rdf_outflow + ", vendor_name_compost_outflow=" + vendor_name_compost_outflow
			+ ", vendor_name_recylables_outflow=" + vendor_name_recylables_outflow + ", vendor_name_inserts_outflow="
			+ vendor_name_inserts_outflow + ", total_rdf=" + total_rdf + ", total_compost=" + total_compost
			+ ", total_inerts=" + total_inerts + ", total_plastic=" + total_plastic + ", total_recylables="
			+ total_recylables + ", quantity_measure_rdf=" + quantity_measure_rdf + ", quantity_measure_compost="
			+ quantity_measure_compost + ", quantity_measure_inerts=" + quantity_measure_inerts
			+ ", quantity_measure_recylabels=" + quantity_measure_recylabels + ", disposal_total_waste="
			+ disposal_total_waste + ", disposal_dlf=" + disposal_dlf + ", disposal_lat=" + disposal_lat
			+ ", disposal_incineration=" + disposal_incineration + ", disposal_total_waste_measure="
			+ disposal_total_waste_measure + ", disposal_dlf_measure=" + disposal_dlf_measure
			+ ", disposal_lat_measure=" + disposal_lat_measure + ", disposal_incineration_measure="
			+ disposal_incineration_measure + ", stock_total_waste=" + stock_total_waste + ", stock_dlf=" + stock_dlf
			+ ", stock_lat=" + stock_lat + ", stock_incineration=" + stock_incineration + ", stock_afrf=" + stock_afrf
			+ ", stock_total_waste_measure=" + stock_total_waste_measure + ", stock_dlf_measure=" + stock_dlf_measure
			+ ", stock_lat_measure=" + stock_lat_measure + ", mergedValue=" + mergedValue
			+ ", stock_incineration_measure=" + stock_incineration_measure + ", disposal_afrf_measure="
			+ disposal_afrf_measure + ", disposal_afrf=" + disposal_afrf + ", stock_afrf_measure=" + stock_afrf_measure
			+ ", from_date=" + from_date + ", to_date=" + to_date + ", isMobile=" + isMobile + ", startIndex="
			+ startIndex + ", offset=" + offset + ", getMergedValue()=" + getMergedValue() + ", getIsMobile()="
			+ getIsMobile() + ", getQuantity_measure_rdf_outflow()=" + getQuantity_measure_rdf_outflow()
			+ ", getQuantity_measure_compost_outflow()=" + getQuantity_measure_compost_outflow()
			+ ", getQuantity_measure_recyclables_outflow()=" + getQuantity_measure_recyclables_outflow()
			+ ", getQuantity_measure_inerts_outflow()=" + getQuantity_measure_inerts_outflow() + ", getStartIndex()="
			+ getStartIndex() + ", getOffset()=" + getOffset() + ", getTotal_plastic()=" + getTotal_plastic()
			+ ", getDisposal_afrf()=" + getDisposal_afrf() + ", getDisposal_afrf_measure()="
			+ getDisposal_afrf_measure() + ", getStatus()=" + getStatus() + ", getFrom_date()=" + getFrom_date()
			+ ", getTo_date()=" + getTo_date() + ", getSite_name()=" + getSite_name() + ", getId()=" + getId()
			+ ", getTotal_materials()=" + getTotal_materials() + ", getTotal_recylable()=" + getTotal_recylable()
			+ ", getTotal_bags()=" + getTotal_bags() + ", getTotal_glass()=" + getTotal_glass()
			+ ", getTotal_cardboard()=" + getTotal_cardboard() + ", getQuality_measure_materials()="
			+ getQuality_measure_materials() + ", getQuality_measure_recylable()=" + getQuality_measure_recylable()
			+ ", getQuality_measure_plastics()=" + getQuality_measure_plastics() + ", getQuality_measure_bags()="
			+ getQuality_measure_bags() + ", getQuality_measure_glass()=" + getQuality_measure_glass()
			+ ", getQuality_measure_cardboard()=" + getQuality_measure_cardboard() + ", getSite()=" + getSite()
			+ ", getComments()=" + getComments() + ", getDate()=" + getDate() + ", getCreated_by()=" + getCreated_by()
			+ ", getModified_date()=" + getModified_date() + ", getCreated_date()=" + getCreated_date()
			+ ", getModified_by()=" + getModified_by() + ", getTotal_waste()=" + getTotal_waste()
			+ ", getTotal_incieration()=" + getTotal_incieration() + ", getTotal_autoclave()=" + getTotal_autoclave()
			+ ", getQuantity_measure_waste()=" + getQuantity_measure_waste() + ", getQuantity_measure_incieration()="
			+ getQuantity_measure_incieration() + ", getQuantity_measure_autoclave()=" + getQuantity_measure_autoclave()
			+ ", getSbu_code()=" + getSbu_code() + ", getQuantity()=" + getQuantity() + ", getQuantity_measure()="
			+ getQuantity_measure() + ", getRole()=" + getRole() + ", getDepartment_code()=" + getDepartment_code()
			+ ", getDepartment_name()=" + getDepartment_name() + ", getRdf()=" + getRdf() + ", getCompost()="
			+ getCompost() + ", getRecyclables()=" + getRecyclables() + ", getInserts()=" + getInserts()
			+ ", getVendor_name_rdf()=" + getVendor_name_rdf() + ", getVendor_name_compost()="
			+ getVendor_name_compost() + ", getVendor_name_recyclables()=" + getVendor_name_recyclables()
			+ ", getVendor_name_inserts()=" + getVendor_name_inserts() + ", getVendor_name_rdf_outflow()="
			+ getVendor_name_rdf_outflow() + ", getVendor_name_compost_outflow()=" + getVendor_name_compost_outflow()
			+ ", getVendor_name_recylables_outflow()=" + getVendor_name_recylables_outflow()
			+ ", getVendor_name_inserts_outflow()=" + getVendor_name_inserts_outflow() + ", getTotal_rdf()="
			+ getTotal_rdf() + ", getTotal_compost()=" + getTotal_compost() + ", getTotal_inerts()=" + getTotal_inerts()
			+ ", getTotal_recylables()=" + getTotal_recylables() + ", getQuantity_measure_rdf()="
			+ getQuantity_measure_rdf() + ", getQuantity_measure_compost()=" + getQuantity_measure_compost()
			+ ", getQuantity_measure_inerts()=" + getQuantity_measure_inerts() + ", getQuantity_measure_recylabels()="
			+ getQuantity_measure_recylabels() + ", getDisposal_total_waste()=" + getDisposal_total_waste()
			+ ", getDisposal_dlf()=" + getDisposal_dlf() + ", getDisposal_lat()=" + getDisposal_lat()
			+ ", getDisposal_incineration()=" + getDisposal_incineration() + ", getDisposal_total_waste_measure()="
			+ getDisposal_total_waste_measure() + ", getDisposal_dlf_measure()=" + getDisposal_dlf_measure()
			+ ", getDisposal_lat_measure()=" + getDisposal_lat_measure() + ", getDisposal_incineration_measure()="
			+ getDisposal_incineration_measure() + ", getStock_total_waste()=" + getStock_total_waste()
			+ ", getStock_dlf()=" + getStock_dlf() + ", getStock_lat()=" + getStock_lat() + ", getStock_incineration()="
			+ getStock_incineration() + ", getStock_afrf()=" + getStock_afrf() + ", getStock_total_waste_measure()="
			+ getStock_total_waste_measure() + ", getStock_dlf_measure()=" + getStock_dlf_measure()
			+ ", getStock_lat_measure()=" + getStock_lat_measure() + ", getStock_incineration_measure()="
			+ getStock_incineration_measure() + ", getStock_afrf_measure()=" + getStock_afrf_measure() + ", getClass()="
