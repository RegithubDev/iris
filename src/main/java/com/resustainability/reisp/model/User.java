...
public class User {
	...
	company_code,	project_code,site_id,	project_name,	status,	created_date,category_name,state_name,	created_by,	modified_date,	modified_by,all_users,active_users,inActive_users,
